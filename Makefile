...
# cloudkit.openshift.io/bare-metal-operator-bundle:$VERSION and cloudkit.openshift.io/bare-metal-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= cloudkit.openshift.io/bare-metal-operator
